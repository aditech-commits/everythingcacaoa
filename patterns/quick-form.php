<?php
/**
 * Title: Direct Inquiry Contact Form
 * Slug: everything-cacao/quick-form
 * Categories: everything-cacao, contact
 * Description: Direct contact inquiry form section with name, email, message fields.
 */
?>
<!-- wp:group {"className":"py-24 max-w-4xl mx-auto px-6 md:px-12","layout":{"type":"constrained"}} -->
<div class="wp-block-group py-24 max-w-4xl mx-auto px-6 md:px-12">
  <div class="bg-cacao-dark text-canvas rounded-xl p-8 md:p-12 border border-cacao-dark shadow-2xl space-y-6">
    <div class="space-y-2 text-center max-w-lg mx-auto">
      ...
      <p class="text-xs text-canvas/70 leading-relaxed">
        Have a question about custom gifting, tasting masterclasses, or orders? Send us a message below.
      </p>
    </div>
