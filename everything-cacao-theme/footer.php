    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
      <div class="space-y-4">
        <a href="<?php echo $link_home; ?>" class="inline-block group shrink-0">
          ...
          <span class="text-lg sm:text-xl md:text-2xl lg:text-2xl font-bold tracking-wide text-accent-gold footer-logo-text brand-heading font-brand-logo mt-2.5 block transition-transform duration-300 group-hover:scale-105" style="font-family: 'Playfair Display', serif; letter-spacing: 0.08em;">EVERYTHING CACAO</span>
        </a>
