...
function ec_customize_register($wp_customize) {
    ...
    $wp_customize->add_setting('ec_header_logo_url', array(
        'default'           => 'https://everythingcacaogh.com/wp-content/uploads/2026/09/everything_cacao_header_logo.png',
        'type'              => 'option',
        'sanitize_callback' => 'esc_url_raw',
        'transport'         => 'refresh',
    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'ec_header_logo_url', array(
        'label'       => __('Header Logo', 'everything-cacao'),
        'description' => __('Upload or select the header logo image. Recommended: transparent PNG, ~600×100px.', 'everything-cacao'),
