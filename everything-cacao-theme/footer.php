    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
      <div class="space-y-4">
        <a href="<?php echo $link_home; ?>" class="inline-block group shrink-0">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/logo-text-butler-gold.png" alt="EVERYTHING CACAO" class="h-6 sm:h-7 md:h-8 lg:h-9 w-auto shrink-0 object-contain footer-logo-text brand-heading font-brand-logo mt-2.5 transition-transform duration-300 group-hover:scale-105" />
        </a>
