...
$ec_footer_logo_text_img_h    = get_option('ec_footer_logo_text_image_height', '55');
$ec_footer_logo_text_img_h_v  = !empty($ec_footer_logo_text_img_h) ? intval($ec_footer_logo_text_img_h) : 55;
