<?php
/**
 * Template Part: Persistent Floating WhatsApp Order Button
 *
...
<a href="https://wa.me/<?php echo esc_attr($wa_number); ?>?text=Hi%20Everything%20Cacao%20GH!%20I'd%20like%20to%20order%20artisanal%20chocolate." 
   ...
   aria-label="Direct WhatsApp Order Assistant">
  ...
  <span class="hidden md:inline font-semibold text-xs uppercase tracking-wider pr-1">WhatsApp Order</span>
</a>
